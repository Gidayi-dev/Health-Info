  ...
  return (
    <div style={containerStyle}>
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
        ...
        <input value={programId} onChange={(e) => setProgramId(e.target.value)} placeholder="Program ID" style={inputStyle} />
        <button type="submit" style={buttonStyle}>Enroll Client</button>
      </form>
    </div>
  );
};
...
const buttonStyle = { backgroundColor: '#ffc107', color: '#000', padding: '10px', border: 'none', borderRadius: '5px', fontSize: '16px', cursor: 'pointer' };
